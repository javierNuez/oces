 ...
 *   https://datatables.net/download/#dt/dt-1.13.1/b-2.3.2/b-html5-2.3.2/date-1.2.0/sb-1.4.0
 *
 * Included libraries:
 *   DataTables 1.13.1, Buttons 2.3.2, HTML5 export 2.3.2, DateTime 1.2.0, SearchBuilder 1.4.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"dt/dt-1.13.1/b-2.3.2/b-html5-2.3.2/date-1.2.0/sb-1.4.0",
